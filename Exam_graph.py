...
'''
ax = sns.scatterplot(predictionsRF,predictionsDT)
ax.set(xlabel="predictionsRF", ylabel="predictionsDT")
...
plt.plot( 'predictionsRF', 'y', data=RF, linestyle='none', marker='o')
